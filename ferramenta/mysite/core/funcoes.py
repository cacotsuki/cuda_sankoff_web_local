...
def linux():
    subprocess.check_output(['dos2unix', '008.fasta'], cwd='/home/livanski/Music/seq_maior/cuda_sankoff/seqs' )
    a = subprocess.check_output(['./bin/sankoff', 'seqs/008.fasta'], cwd='/home/livanski/Music/seq_maior/cuda_sankoff')
    str(a,'utf-8')
...
def salva_na_pasta_vienna():
    ...
    #                       cwd='/home/livanski/Music/seq_maior/cuda_sankoff/ViennaRNA-2.3.3')
    shutil.copyfile('/home/livanski/Music/seq_maior/servidor_apresentacao/ferramenta/resultado_cuda_sankoff.txt', '/home/livanski/Music/seq_maior/cuda_sankoff/ViennaRNA-2.3.3/resultado_cuda_sankoff.txt')
...
def executa_shell():
    ...
    #                         cwd='/home/livanski/Music/seq_maior/cuda_sankoff/ViennaRNA-2.3.3')
    shutil.copyfile('/home/livanski/Music/seq_maior/cuda_sankoff/ViennaRNA-2.3.3/rna_convertido.png', '/home/livanski/Music/seq_maior/servidor_apresentacao/ferramenta/mysite/static/css/rna_convertido.png')
...
def write_sequence(text_area):
    wrt = open('/home/livanski/Music/seq_maior/cuda_sankoff/seqs/008.fasta', 'w')
...
def read_file():
   # subprocess.check_output(['dos2unix', 'write.fasta'], cwd='/home/livanski/Documents/danielsundfeld-hpc/seqs')
    ...
    ler = open('/home/livanski/Music/seq_maior/cuda_sankoff/seqs/008.fasta','r')
    read = ler.readline()
    return read
...
def data_visualization():
    ...
    pylab.savefig('/home/livanski/Music/seq_maior/servidor_apresentacao/ferramenta/mysite/static/css/graph.png', dpi=100)
    pylab.savefig('/home/livanski/Music/seq_maior/servidor_apresentacao/ferramenta/mysite/static/css/graph.png', dpi=100)
    return pylab.show
